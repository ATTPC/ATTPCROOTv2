...
S800Ana::S800Ana() : fLogger(FairLogger::GetLogger()), fXfObj_ToF(-999), fObjCorr_ToF(-999), fICSum_E(-999), fX0(-999),
                     fX1(-999), fAfp(-999)
{
   fcutPID1.clear();
   fcutPID2.clear();
...
Bool_t S800Ana::isInPID(S800Calc *s800calc)
{
   ...
   // std::cout << " S800Ana : Number of TCutG files  " << fcutPID1.size() << " " << fcutPID2.size() << " " << fcutPID3.size() << " "
