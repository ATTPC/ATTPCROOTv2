...
AtConstField::AtConstField(const char* name, Double_t xMin, 
...
{
  if ( ! fieldPar ) {
    cerr << "-W- AtConstField::AtConstField: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void AtConstField::SetFieldRegion(Double_t xMin, Double_t xMax, 
