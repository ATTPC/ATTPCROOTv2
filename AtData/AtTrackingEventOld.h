#ifndef AtTRACKINGEVENTOLD_H
#define AtTRACKINGEVENTOLD_H
...
class [[deprecated]] AtTrackingEventOld : public AtBaseEvent {
   ...
   using FTrackPtr = std::unique_ptr<AtFittedTrackOld>;
   using FTrackVector = std::vector<FTrackPtr>;

public:
   AtTrackingEventOld();
   virtual ~AtTrackingEventOld() = default;
   ...
   AtFittedTrackOld &AddFittedTrack(std::unique_ptr<AtFittedTrackOld> ptr)
   {
