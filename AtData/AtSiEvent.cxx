...
void AtSiEvent::BuildHits()
{ // Returning strips to build physical map of Si detectors. For now focusing on multiplicity of 1 or 2
   bool valid1 = true;
   if (fMultiplicityFront1 ==
       1) { // To-Do: there are many strips within the reaction runs that have a multiplicity>2. Might be beneficial to
            // implement other combinations of multiplicities so we are not throwing out data.
      // everything is easy
