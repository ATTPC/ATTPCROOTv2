...
TGeoVolume *create_detector()
{
   ...
   */
   ...
   TGeoVolume *drift_volume = gGeoManager->MakeTube("drift_volume", gas, 0, SPMT_active_volume_radius, SPMT_active_volume_halflength);
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(drift_volume, 1,
                new TGeoCombiTrans(0, 0, 3.25, new TGeoRotation("drift_volume", 0, tpc_rot, 0)));
   ...
   TGeoVolume *field_cage = gGeoManager->MakeTube("field_cage", Epoxymat, SPMT_active_volume_radius, SPMT_fieldcage_outerradius, SPMT_fieldcage_halflength);
  ...
  TGeoVolume *vacuum_chamber = gGeoManager->MakeTube("vacuum_chamber", Aluminum5083mat, vacuumchamber_innerradius, vacuumchamber_outerradius, vacuumchamber_halflength);
  ...
  TGeoVolume *vacuum_chamber2 = gGeoManager->MakeTube("vacuum_chamber2", Aluminum5083mat, vacuumchamber2_innerradius, vacuumchamber2_outerradius, vacuumchamber2_halflength);
  vacuum_chamber2->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber2, 1, new TGeoCombiTrans(0.0, 0.0, -10.725, new TGeoRotation("vacuum_chamber2", 0, tpc_rot, 0)));
  ...
  TGeoVolume *vacuum_chamber3 = gGeoManager->MakeTube("vacuum_chamber3", Aluminum5083mat, vacuumchamber3_innerradius, vacuumchamber3_outerradius, vacuumchamber3_halflength);
  vacuum_chamber3->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber3, 1, new TGeoCombiTrans(0.0, 0.0, -11.725, new TGeoRotation("vacuum_chamber3", 0, tpc_rot, 0)));
  ...
  TGeoVolume *vacuum_chamber4 = gGeoManager->MakeTube("vacuum_chamber4", Aluminum5083mat, vacuumchamber4_innerradius, vacuumchamber4_outerradius, vacuumchamber4_halflength);
  vacuum_chamber4->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber4, 1, new TGeoCombiTrans(0.0, 0.0, -13.725, new TGeoRotation("vacuum_chamber4", 0, tpc_rot, 0)));
  ...
  TGeoVolume *vacuum_chamber5 = gGeoManager->MakeTube("vacuum_chamber5", Aluminum5083mat, vacuumchamber5_innerradius, vacuumchamber5_outerradius, vacuumchamber5_halflength);
  vacuum_chamber5->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber5, 1, new TGeoCombiTrans(0.0, 0.0, 10.975, new TGeoRotation("vacuum_chamber5", 0, tpc_rot, 0)));
  ...
  TGeoVolume *vacuum_chamber6 = gGeoManager->MakeTube("vacuum_chamber6", Aluminum5083mat, vacuumchamber6_innerradius, vacuumchamber6_outerradius, vacuumchamber6_halflength);
  vacuum_chamber6->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber6, 1, new TGeoCombiTrans(0.0, 0.0, 15.475, new TGeoRotation("vacuum_chamber6", 0, tpc_rot, 0)));
  ...
  TGeoVolume *vacuum_chamber7 = gGeoManager->MakeTube("vacuum_chamber7", Aluminum5083mat, vacuumchamber7_innerradius, vacuumchamber7_outerradius, vacuumchamber7_halflength);
  vacuum_chamber7->SetLineColor(kGray);
  gGeoMan->GetVolume(geoVersion)
    ->AddNode(vacuum_chamber7, 1, new TGeoCombiTrans(0.0, 0.0, 20.225, new TGeoRotation("vacuum_chamber7", 0, tpc_rot, 0)));
