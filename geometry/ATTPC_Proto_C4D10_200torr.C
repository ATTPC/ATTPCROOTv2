...
const TString geoVersion = "ATTPC_Proto_C4D10_200torr";
const TString FileName = geoVersion + ".root";
const TString FileName1 = geoVersion + "_geomanager.root";

// Names of the different used materials which are used to build the modules
// The materials are defined in the global media.geo file
const TString MediumGas     = "ATTPCDIsoButane_200";
...
TGeoManager* gGeoMan = new TGeoManager("ATTPC_Proto","ATTPC_Proto");;  // Pointer to TGeoManager instance
...
void ATTPC_Proto_C4D10_200torr() {
...
void create_materials_from_media_file()
{
  ...
  FairGeoMedium* ATTPCDIsoButane_200    = geoMedia->getMedium("ATTPCDIsoButane_200");
  ...
  geoBuild->createMedium(ATTPCDIsoButane_200);
