...
const TString geoVersion = "RCNP_ATTPC_450torr";
const TString FileName = geoVersion + ".root";
const TString FileName1 = geoVersion + "_geomanager.root";

// Names of the different used materials which are used to build the modules
// The materials are defined in the global media.geo file
const TString MediumGas = "ATTPCDPropane_450torr";
...
void create_materials_from_media_file()
{
   ...
   FairGeoMedium *disobutane = geoMedia->getMedium("ATTPCDPropane_450torr");
...
TGeoVolume *create_detector()
{
   ...
   TGeoVolume *tpc_window2 = gGeoManager->MakeTube("tpc_window2", windowmat, 0, 1.00 / 2.0, 0.00036 / 2.0);
   tpc_window2->SetLineColor(kBlue);
   gGeoMan->GetVolume(geoVersion)
