...
const Float_t tpc_diameter = 58.4;
...
void create_materials_from_media_file()
{
  ...
  FairGeoMedium* heco2_600Torr          = geoMedia->getMedium("heco2_600Torr");
  ...
  geoBuild->createMedium(steel);
   geoBuild->createMedium(heco2_600Torr);
