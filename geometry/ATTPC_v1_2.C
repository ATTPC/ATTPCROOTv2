...
const TString geoVersion = "ATTPC_v1.2";
...
TGeoVolume *create_detector()
{
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(drift_volume, 1,
                new TGeoCombiTrans(0.0, 6.079, drift_length / 2.0, new TGeoRotation("drift_volume", 0, tpc_rot, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_drift_volume_1, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 + 1.375 + (0.5000005 / 2.0),
                                   new TGeoRotation("IC_drift_volume_Out", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_drift_volume_2, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 - 1.375 - (0.5000005 / 2.0),
                                   new TGeoRotation("IC_drift_volume_In", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_window_1, 1, new TGeoCombiTrans(0.0, 0.0, -50.0, new TGeoRotation("IC_window_Mid", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_window_2, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 + 6.0 / 2.0, new TGeoRotation("IC_window_Out", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_window_3, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 - 6.0 / 2.0, new TGeoRotation("IC_window_In", 0, 0, 0)));

   // IC Aluminum layers

   TGeoVolume *IC_Al_window_1 =
      gGeoManager->MakeTube("IC_window_1_Mid_Al", ICAlwindowmat, 0, 3.81 / 2.0, 0.000005 / 2.0);
   IC_Al_window_1->SetLineColor(kBlue + 3);
   IC_Al_window_1->SetTransparency(50);
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_Al_window_1, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 + 0.050005, new TGeoRotation("IC_window_1_Mid_Al", 0, 0, 0)));

   TGeoVolume *IC_Al_window_2 =
      gGeoManager->MakeTube("IC_window_2_Mid_Al", ICAlwindowmat, 0, 3.81 / 2.0, 0.000005 / 2.0);
   IC_Al_window_2->SetLineColor(kBlue + 3);
   IC_Al_window_2->SetTransparency(50);
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_Al_window_2, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 - 0.050005, new TGeoRotation("IC_window_2_Mid_Al", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_Al_window_3, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 + 6.0 / 2.0 + 0.050005 / 2.0,
                                   new TGeoRotation("IC_Al_window_Out", 0, 0, 0)));
   ...
   gGeoMan->GetVolume(geoVersion)
      ->AddNode(IC_Al_window_4, 1,
                new TGeoCombiTrans(0.0, 0.0, -50.0 - 6.0 / 2.0 - 0.050005 / 2.0,
                                   new TGeoRotation("IC_Al_window_In", 0, 0, 0)));
