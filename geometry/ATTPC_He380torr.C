...
TGeoVolume* create_detector()
{
  ...
  */
  ...
  gGeoMan->GetVolume(geoVersion)->AddNode(drift_volume, 1,
					  new TGeoCombiTrans(0.0, 6.079, drift_length/2.0,
  ...
  gGeoMan->GetVolume(geoVersion)->AddNode(tpc_window, 1,
