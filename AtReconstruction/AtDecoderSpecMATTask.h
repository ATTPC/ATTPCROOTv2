...
public:
   ...
   /// Setting use gain calibration data file. If there's no file specified by
   /// user using two methods below, it'll use the one in parameter files.
...
private:
   ...
   AtCoreSpecMAT *fDecoder; ///< AtConverter pointer
   ...
   // Double_t fGainConstant;             ///< Gain calibration reference
   // constant Double_t fGainLinear;               ///< Gain calibration
   // reference coefficient of linear term Double_t fGainQuadratic; ///< Gain
   // calibration reference coefficient of quadratic term
