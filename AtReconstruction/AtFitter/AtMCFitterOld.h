#ifndef ATMCFITTEROLD_H
#define ATMCFITTEROLD_H

#include "AtEvent.h"
#include "AtMCResultOld.h" // for AtMCResult
...
class [[deprecated]] AtMCFitterOld {
protected:
   ...
   std::set<AtMCResultOld, std::function<bool(AtMCResultOld, AtMCResultOld)>> fResults;

public:
   AtMCFitterOld(SimPtr sim, ClusterPtr cluster, PulsePtr pulse);
   virtual ~AtMCFitterOld() = default;
...
protected:
    ...
    */
   virtual double ObjectiveFunction(const AtBaseEvent &expEvent, int SimEventID, AtMCResultOld &definition) = 0;
    ...
    */
   virtual TClonesArray SimulateEvent(AtMCResultOld &definition) = 0;
    ...
    */
   virtual AtMCResultOld DefineEvent();
