...
ClassImp(AtFITTER::AtFitterOld);

AtFITTER::AtFitterOld::AtFitterOld() = default;

AtFITTER::AtFitterOld::~AtFitterOld() = default;

std::tuple<Double_t, Double_t> AtFITTER::AtFitterOld::GetMomFromBrho(Double_t M, Double_t Z, Double_t brho)
{
...
Bool_t AtFITTER::AtFitterOld::FindVertexTrack(AtTrack *trA, AtTrack *trB)
{
...
Bool_t AtFITTER::AtFitterOld::MergeTracks(std::vector<AtTrack *> *trackCandSource, std::vector<AtTrack> *trackDest,
                                          Bool_t enableSingleVertexTrack, Double_t clusterRadius,
...
[[deprecated]] void
AtFITTER::AtFitterOld::MergeTracks(std::vector<AtTrack> *trackCandSource, std::vector<AtTrack> *trackJunkSource,
