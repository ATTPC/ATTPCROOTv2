#ifndef AtFITTEROLD_H
#define AtFITTEROLD_H
...
class [[deprecated]] AtFitterOld : public TObject {

public:
   AtFitterOld();
   virtual ~AtFitterOld();
   virtual std::vector<std::unique_ptr<AtFittedTrackOld>> ProcessTracks(std::vector<AtTrack> &tracks) = 0;
   virtual void Init() = 0;
