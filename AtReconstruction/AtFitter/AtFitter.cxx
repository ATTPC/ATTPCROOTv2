...
void AtFITTER::AtFitter::MergeTracks(std::vector<AtTrack>* trackCandSource,std::vector<AtTrack>* trackJunkSource,std::vector<AtTrack>* trackDest,bool fitDirection, bool simulationConv)
{

  //Track destination are the merged tracks.
  //Track candidate source are the main tracks identified as candidates.
  //Track junk source are the tracks from which clusters will be extracted. Boundary conditions are applied: Proximity in space, angle and center.
