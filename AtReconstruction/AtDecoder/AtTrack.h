...
public:
   ...
   void SetPosMin(const std::vector<Double_t> &xmin, const std::vector<Double_t> &ymin,
   ...
   void SetPosExp(const std::vector<Double_t> &xexp, const std::vector<Double_t> &yexp,
...
protected:
   ...
   friend inline std::ostream &operator<<(std::ostream &o, const AtTrack &track)
   {
      ...
      std::cout << " Scattering Angle : " << track.FitParameters.sThetaMin * (180.0 / TMath::Pi()) << " deg "
                << " - Azimuthal Angle : " << track.FitParameters.sPhiMin * (180.0 / TMath::Pi()) << " deg "
                << std::endl;
      ...
      std::cout << " Chi2 : " << track.FitParameters.sChi2Min << " - Chi2Q : " << track.FitParameters.sChi2Q
                << " - Chi2Range : " << track.FitParameters.sChi2Range << std::endl;
