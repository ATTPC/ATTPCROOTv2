...
void Opt::set_parameters(double _s, double _k, double _n, double _m, double _r,double _a, double _t)
{
  ...
  //std::cout<<" Set parameters - s, "<<this->s<<" - k, "<<this->k<<" - n, "<<this->n<<" - m, "<<this->m<<" - r, "<<this->r<<" - a, "<<this->a<<" - t, "<<this->t<<"\n";
  //std::cout<<" Parameters set by default (not accessible) - rdnn, "<<this->rdnn<<" - sdnn, "<<this->sdnn<<" - tauto, "<<this->tauto<<" - dmax, "<<this->dmax<<" - isdmax, "<<this->isdmax<<" - dmax_dnn, "<<this->dmax_dnn<<" - Link, "<<this->link<<"\n"; 
}
