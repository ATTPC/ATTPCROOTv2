...
void GETDecoder2::SetNumTbs(Int_t value) { fNumTbs = value; }
...
void GETDecoder2::SetDiscontinuousData(Bool_t value) { fIsContinuousData = !value; }
Bool_t GETDecoder2::NextData() { if (fIsContinuousData) return SetData(fCurrentDataID + 1); else return kFALSE; }
void GETDecoder2::SetPositivePolarity(Bool_t value) { fIsPositivePolarity = value; }
...
Int_t GETDecoder2::GetNumData() { return fDataList.size(); }
...
Int_t GETDecoder2::GetNumTbs() { return fNumTbs; }
GETDecoder2::EFrameType GETDecoder2::GetFrameType() { return fFrameType; }
