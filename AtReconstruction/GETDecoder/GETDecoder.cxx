   ...
   if (!(fData.is_open())) {
      ...
      */
      ...
      if (fFrameType == kNormal)
         std::cout << "Normal CoBo frame";
      else if (fFrameType == kMergedID)
         std::cout << "Event number merged frame";
      else if (fFrameType == kMergedTime)
         std::cout << "Event time merged frame";
      std::cout << std::endl;
