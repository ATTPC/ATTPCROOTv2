...
AtTrajectory::AtTrajectory(std::vector<AtHit> const &hits, Eigen::Vector3f const &centroidPoint,
...
float AtTrajectory::GetPositionOnMainDirection(Eigen::Vector3f const &centroidPoint,
                                               Eigen::Vector3f const &mainDirection, Eigen::Vector3f const &point)
{
