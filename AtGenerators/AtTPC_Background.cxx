...
// Rodriges Formula
std::vector<Double_t>  AtTPC_Background::TRANSF(std::vector<Double_t> *from, std::vector<Double_t> *to, std::vector<Double_t> *vin){
		...
		fPx.at(5) = 0.;
		 ...
		 //K1 = sqrt(pow(fPxBeam*1000.0,2) + pow(fPyBeam*1000.0,2) + pow( fPzBeam*1000.0,2) + pow(m1,2)) - m1;
	    	...
	    	fPz.at(2) = (Pprot1.at(2) )/1000.0; // To GeV for FairRoot
                //std::cout<<"Kin 1  "<< acos(Pprot1.at(2)/( sqrt(  pow(Pprot1.at(0),2) + pow(Pprot1.at(1),2) + pow(Pprot1.at(2),2)) ))*180.0/3.1415<<"  "<<sqrt(  pow(Pprot1.at(0),2) + pow(Pprot1.at(1),2) + pow(Pprot1.at(2),2) + pow(m3,2) ) -m3<<std::endl;
	    	...
	    	fPz.at(3) = (Pprot2.at(2) )/1000.0; // To GeV for FairRoot
                //std::cout<<"Kin 2  "<< acos(Pprot2.at(2)/( sqrt(  pow(Pprot2.at(0),2) + pow(Pprot2.at(1),2) + pow(Pprot2.at(2),2)) ))*180.0/3.1415<<"  "<<sqrt(  pow(Pprot2.at(0),2) + pow(Pprot2.at(1),2) + pow(Pprot2.at(2),2) + pow(m3,2) ) -m3<<std::endl;
	    	...
	    	fPz.at(4) = (Pprot3.at(2) )/1000.0; // To GeV for FairRoot
                //std::cout<<"Kin 3  "<< acos(Pprot3.at(2)/( sqrt(  pow(Pprot3.at(0),2) + pow(Pprot3.at(1),2) + pow(Pprot3.at(2),2)) ))*180.0/3.1415<<"  "<<sqrt(  pow(Pprot3.at(0),2) + pow(Pprot3.at(1),2) + pow(Pprot3.at(2),2) + pow(m3,2) ) -m3<<std::endl;
	    	...
	    	fPz.at(5) = (Pprot4.at(2) )/1000.0; // To GeV for FairRoot
                //std::cout<<"Kin 4  "<< acos(Pprot4.at(2)/( sqrt(  pow(Pprot4.at(0),2) + pow(Pprot4.at(1),2) + pow(Pprot4.at(2),2)) ))*180.0/3.1415<<"  "<<sqrt(  pow(Pprot4.at(0),2) + pow(Pprot4.at(1),2) + pow(Pprot4.at(2),2) + pow(m3,2) ) -m3<<std::endl;
