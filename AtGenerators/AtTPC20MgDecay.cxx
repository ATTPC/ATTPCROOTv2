...
Bool_t AtTPC20MgDecay::ReadEvent(FairPrimaryGenerator *primGen)
{
   ...
   if (!betaParticle)
      LOG(fatal) << "AtTPC20MgDecay: PDG code " << betaPDGID << " (beta) not defined.";
   Double32_t betaMass = betaParticle->Mass();
   ...
   TH1F *h1 = new TH1F("h1", "h1", 1000, 0, 8650); // 984 keV
   TF1 *f1 = new TF1("f1", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 8650);
   ...
   TH1F *h2 = new TH1F("h2", "h2", 1000, 0, 7000); // 2645 keV
   TF1 *f2 = new TF1("f2", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 7000);
   f2->SetParameters(3.21795e-9, 7.31673e-11, 4.05604e-14, -1.61734e-17, 1.25431e-21, 2.00144e-27);
   h2->FillRandom("f2");
   h2->Draw();
   Double32_t r2 = f2->GetRandom();
   ...
   TH1F *h3 = new TH1F("h3", "h3", 1000, 0, 6600); // 3001 kev
   TF1 *f3 = new TF1("f3", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 6600);
   f3->SetParameters(4.12126e-7, 9.72611e-9, 5.16976e-12, -2.22576e-15, 1.81306e-19, 4.8888e-25);
   h3->FillRandom("f3");
   h3->Draw();
   Double32_t r3 = f3->GetRandom();
   ...
   TH1F *h4 = new TH1F("h4", "h4", 1000, 0, 5750); // 3874 keV
   TF1 *f4 = new TF1("f4", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 5750);
   f4->SetParameters(2.28812e-7, 5.99596e-9, 2.76505e-12, -1.49003e-15, 1.37999e-19, 1.00668e-24);
   h4->FillRandom("f4");
   h4->Draw();
   Double32_t r4 = f4->GetRandom();
   ...
   TH1F *h5 = new TH1F("h5", "h5", 1000, 0, 5500); // 4123 keV
   TF1 *f5 = new TF1("f5", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 5500);
   f5->SetParameters(1.40485e-7, 3.80994e-9, 1.66204e-12, -9.67707e-16, 9.31417e-20, 8.78505e-25);
   h5->FillRandom("f5");
   h5->Draw();
   Double32_t r5 = f5->GetRandom();
   ...
   TH1F *h6 = new TH1F("h6", "h6", 1000, 0, 4810); // 4800 keV
   TF1 *f6 = new TF1("f6", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 4810);
   f6->SetParameters(1.27496e-7, 3.84163e-9, 1.35989e-12, -1.02747e-15, 1.10166e-19, 2.06696e-24);
   h6->FillRandom("f6");
   h6->Draw();
   Double32_t r6 = f6->GetRandom();
   ...
   TH1F *h7 = new TH1F("h7", "h7", 1000, 0, 4010); // 5600
   TF1 *f7 = new TF1("f7", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 4010);
   f7->SetParameters(1.40707e-7, 4.9678e-9, 1.07582e-12, -1.36341e-15, 1.65065e-19, 7.62092e-24);
   h7->FillRandom("f7");
   h7->Draw();
   Double32_t r7 = f7->GetRandom();
   ...
   TH1F *h8 = new TH1F("h8", "h8", 1000, 0, 3770.); // 5836 keV
   TF1 *f8 = new TF1("f8", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 3770);
   f8->SetParameters(7.89154e-7, 2.94918e-8, 4.8237e-12, -8.02751e-15, 9.98793e-19, 6.29715e-23);
   h8->FillRandom("f8");
   h8->Draw();
   Double32_t r8 = f8->GetRandom();
   ...
   TH1F *h9 = new TH1F("h9", "h9", 1000, 0, 3340); // 6266 keV
   TF1 *f9 = new TF1("f9", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 3340);
   f9->SetParameters(1.5398e-7, 6.4777e-9, 3.04221e-13, -1.67316e-15, 2.11676e-19, 2.6079e-23);
   h9->FillRandom("f9");
   h9->Draw();
   Double32_t r9 = f9->GetRandom();
   ...
   TH1F *h10 = new TH1F("h10", "h10", 1000, 0, 3071); // 6534
   TF1 *f10 = new TF1("f10", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 3071);
   f10->SetParameters(4.84941e-7, 2.22562e-8, -9.262068e-13, -5.32068e-15, 6.40919e-19, 1.36991e-22);
   h10->FillRandom("f10");
   h10->Draw();
   delete h10;
   Double32_t r10 = f10->GetRandom();
   ...
   TH1F *h11 = new TH1F("h11", "h11", 1000, 0, 2835); // 6770 keV
   TF1 *f11 = new TF1("f11", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2835);
   f11->SetParameters(1.33516e-6, 6.68463e-8, -9.17265e-12, -1.41377e-14, 1.4453e-18, 6.10901e-22);
   h11->FillRandom("f11");
   h11->Draw();
   Double32_t r11 = f11->GetRandom();
   ...
   TH1F *h12 = new TH1F("h12", "h12", 1000, 0, 2685); // 6920 keV
   TF1 *f12 = new TF1("f12", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2685);
   f12->SetParameters(9.03068e-7, 4.81333e-8, -9.93371e-12, -8.9499e-15, 6.66662e-19, 5.74898e-22);
   h12->FillRandom("f12");
   h12->Draw();
   Double32_t r12 = f12->GetRandom();
   ...
   TH1F *h14 = new TH1F("h14", "h14", 1000, 0, 11236.8);
   TF1 *f14 = new TF1("f14", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 11236.8);
   f14->SetParameters(1.59711e-7, 1.68487e-8, 1.0013e-11, -2.1646e-15, 9.92165e-20, 2.01015e-25);
   h14->FillRandom("f14");
   h14->Draw();
   Double32_t r14 = f14->GetRandom();
   // std::cout<<"r1="<<r1<<std::endl;
   delete h14;
   ...
   TH1F *h15 = new TH1F("h15", "h15", 1000, 0, 5448.6); // 11320 keV
   TF1 *f15 = new TF1("f15", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 5448.6);
   f15->SetParameters(3.1588e-8, 1.25472e-9, 6.2571e-14, -3.16054e-16, 3.84227e-20, 5.00163e-24);
   h15->FillRandom("f15");
   h15->Draw();
   Double32_t r15 = f15->GetRandom();
   delete h15;
   ...
   TH1F *h16 = new TH1F("h16", "h16", 1000, 0, 5041.5);
   TF1 *f16 = new TF1("f16", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 5041.5);
   f16->SetParameters(4.55e-9, 2.01854e-10, -1.63887e-14, -4.4892e-17, 4.87227e-21, 1.46295e-24);
   h16->FillRandom("f16");
   h16->Draw();
   Double32_t r16 = f16->GetRandom();
   ...
   TH1F *h17 = new TH1F("h17", "h17", 1000, 0, 4070.5);
   TF1 *f17 = new TF1("f17", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 4070.5);
   f17->SetParameters(5.85765e-7, 3.02486e-8, -7.97958e-12, -4.63986e-15, 7.78501e-20, 4.44419e-22);
   h17->FillRandom("f17");
   h17->Draw();
   Double32_t r17 = f17->GetRandom();
   ...
   TH1F *h18 = new TH1F("h18", "h18", 1000, 0, 6000.);
   TF1 *f18 = new TF1("f18", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 3383.5);
   f18->SetParameters(2.16857e-8, 1.29089e-9, -5.80327e-13, -7.02664e-17, -4.61969e-20, 3.46765e-23);
   h18->FillRandom("f18");
   h18->Draw();
   Double32_t r18 = f18->GetRandom();
   ...
   TH1F *h19 = new TH1F("h19", "h19", 1000, 0, 2997.5);
   TF1 *f19 = new TF1("f19", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2997.5);
   f19->SetParameters(5.06675e-8, 3.48106e-9, -2.25971e-12, 2.97006e-16, -3.48781e-19, 1.63705e-22);
   h19->FillRandom("f19");
   h19->Draw();
   Double32_t r19 = f19->GetRandom();
   ...
   TH1F *h20 = new TH1F("h20", "h20", 1000, 0, 2596.5);
   TF1 *f20 = new TF1("f20", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2596.5);
   f20->SetParameters(3.50494e-8, 2.46542e-9, -1.68544e-12, 2.73518e-16, -2.77506e-19, 1.26138e-22);
   h20->FillRandom("f20");
   h20->Draw();
   Double32_t r20 = f20->GetRandom();
   ...
   TH1F *h21 = new TH1F("h21", "h21", 1000, 0, 2286.5);
   TF1 *f21 = new TF1("f21", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2286.5);
   f21->SetParameters(7.84682e-8, 7.34482e-9, -8.13364e-12, 3.91808e-15, -2.64262e-18, 9.8004e-22);
   h21->FillRandom("f21");
   h21->Draw();
   Double32_t r21 = f21->GetRandom();
   ...
   TH1F *h22 = new TH1F("h22", "h22", 1000, 0, 2027.5);
   TF1 *f22 = new TF1("f22", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 2027.5);
   f22->SetParameters(1.1966e-8, 1.17991e-9, -1.40285e-12, 7.42593e-16, -4.98985e-19, 1.84071e-22);
   h22->FillRandom("f22");
   h22->Draw();
   Double32_t r22 = f22->GetRandom();
   ...
   TH1F *h23 = new TH1F("h23", "h23", 1000, 0, 1986.5);
   TF1 *f23 = new TF1("f23", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 1986.5);
   f23->SetParameters(8.82998e-10, 1.87941e-10, -4.67582e-13, 5.54255e-16, -4.80667e-19, 2.05681e-22);
   h23->FillRandom("f23");
   h23->Draw();
   Double32_t r23 = f23->GetRandom();
   ...
   TH1F *h24 = new TH1F("h24", "h24", 1000, 0, 1605);
   TF1 *f24 = new TF1("f24", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 1605);
   f24->SetParameters(7.8520e-8, 7.34997e-9, -8.14208e-12, 3.92149e-15, -2.6442e-18, 9.80965e-22);
   h24->FillRandom("f24");
   h24->Draw();
   Double32_t r24 = f24->GetRandom();
   ...
   TH1F *h25 = new TH1F("h25", "h25", 1000, 0, 1550);
   TF1 *f25 = new TF1("f25", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 1550);
   f25->SetParameters(1.43596e-8, 1.41593e-9, -1.68346e-12, 8.91141e-16, -5.98803e-19, 2.20892e-22);
   h25->FillRandom("f25");
   h25->Draw();
   Double32_t r25 = f25->GetRandom();
   ...
   TH1F *h26 = new TH1F("h26", "h26", 900, 0, 984);
   TF1 *f26 = new TF1("f26", "[0]+[1]*x+[2]*x*x+[3]*x*x*x+[4]*x*x*x*x+[5]*x*x*x*x*x", 0, 984);
   f26->SetParameters(8.82998e-10, 1.87941e-10, -4.67582e-13, 5.54255e-16, -4.80667e-19, 2.05681e-22);
   h26->FillRandom("f26");
   h26->Draw();
   Double32_t r26 = f26->GetRandom();
