...
public:
   ...
   AtTPCIonGenerator(const char *name, Int_t z, Int_t a, Int_t q, Int_t mult, Double_t px, Double_t py, Double_t pz,
                     Double_t Ex, Double_t m, Double_t ener, Double_t eLoss = -1, TString sata = "", TString sbta = "");
...
private:
   ...
   TH1F *hAta,
      *hBta; // beam angles distributions in dispersive and non dispersive direction (respectively to S800) [rad]
   Int_t fBeamOpt;
