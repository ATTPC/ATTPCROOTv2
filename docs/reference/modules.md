...
| `AtTools` | shared utilities | energy loss (models + factories), kinematics, hit sampling, cleaning, electronic response | algorithmic utilities used across modules | [energy-loss.md](../subsystems/energy-loss.md) |
