...
UInt_t GETBasicFrameHeader::GetHeaderSize(Bool_t inBytes)
{
...
{
   return CorrectEndianness(fWindowOut, 4);
}
...
{
   return GetHeaderSize() - GETBASICFRAMEHEADERSIZE;
}
