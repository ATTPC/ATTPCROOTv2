...
public:
   ...
   void Add(Double_t value); ///< With the mean and RMS, calculated before, use the **value** to calculate new **mean**
                             ///< and **RMS** recursively.
   ...
   void Set(Int_t numValues, Double_t mean,
            Double_t rms2); /// Set the values manually. Note that the last argument is rms squared, that is variance.
...
private:
   ...
   ClassDef(GETMath2, 1) ///< Added for dictionary making by ROOT
};
