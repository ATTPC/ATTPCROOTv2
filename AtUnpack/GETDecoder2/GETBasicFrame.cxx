...
Int_t *GETBasicFrame::GetSample(Int_t agetIdx, Int_t chIdx)
{
   return fSample + GetIndex(agetIdx, chIdx, 0);
}

Int_t GETBasicFrame::GetFrameSkip()
{
   return GetFrameSize() - GETBASICFRAMEHEADERSIZE - GetHeaderSkip() - GetItemSize() * GetNItems();
}
...
UInt_t GETBasicFrame::GetIndex(Int_t agetIdx, Int_t chIdx, Int_t tbIdx)
{
   return agetIdx * 68 * 512 + chIdx * 512 + tbIdx;
}
