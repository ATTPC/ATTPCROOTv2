#ifndef ATFRIBSIONLYUNPACKER_H
#define ATFRIBSIONLYUNPACKER_H
...
class AtFRIBSiOnlyUnpacker : public AtFRIBLinkedHDFUnpacker {
protected:
...
public:
   AtFRIBSiOnlyUnpacker(mapPtr map) : AtFRIBLinkedHDFUnpacker(map)
   {
      fFribPaths = {"977", "1903", "1904", "1905", "1906"};
      fGetPath = "/get";
   };
   ~AtFRIBSiOnlyUnpacker() = default;
...
protected:
   ...
   ClassDefOverride(AtFRIBSiOnlyUnpacker, 1);
};

#endif // ATFRIBSIONLYUNPACKER_H
