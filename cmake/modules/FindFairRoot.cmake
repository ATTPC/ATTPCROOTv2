...
foreach(_fairroot_dep ${_fairroot_deps})
  ...
  if(${_fairroot_dep}_LIB)
    ...
    target_link_libraries(FairRoot::${_fairroot_dep} INTERFACE ${_${_fairroot_dep}_deps})
    message(STATUS "FairRoot::${_fairroot_dep} (${${_fairroot_dep}_LIB}) target added by hand.")
    message(STATUS "FairRoot::${_fairroot_dep} requires ${_${_fairroot_dep}_deps}")
  else()
