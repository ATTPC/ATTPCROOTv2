...
*
* Edited for CUDA execution by M.P. Kuchera 4/12/2016                        *
********************************************************************/
#ifndef MCMIN_H
#define MCMIN_H
...
class MCMinimization{
  ...
  public:
    ...
    __device__ __host__ void GetEnergy(Double_t M,Double_t IZ,Double_t BRO,Double_t &E);
