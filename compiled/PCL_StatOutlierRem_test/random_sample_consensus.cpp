...
main(int argc, char** argv)
{
  ...
  {
   hitPatternFiltered->SetPoint(hitPatternFiltered->GetN(),cloud_filtered->points[iFil].x,cloud_filtered->points[iFil].y);
   hitPatternFilteredXZ->SetPoint(hitPatternFilteredXZ->GetN(),cloud_filtered->points[iFil].x,cloud_filtered->points[iFil].z);
