...
#ifndef ATDEGAIDIGITIZER_H
#define ATDEGAIDIGITIZER_H
...
public:
    ...
    **
    ** Adds a DeGAiCrystalCal data
    **/
   AtDeGAiCrystalCalData *AddCrystalCal(Int_t ident, Double_t energy, ULong64_t time);
