void run_KineFitting()
{
  ...
  Double_t m_B;
   ...
   ROOT::Math::XYZVector momSca(0.032863*1000.0,0.133326*1000.0,0.136415*1000.0);
   Double_t EScaTot = 9.96088 + m_d;//Ekin + mass
   std::cout<<" Scattered momentum "<<sqrt(momSca.Mag2())<<"\n";
   std::cout<<" Scattered energy (from momentum) "<<sqrt(momSca.Mag2() + m_d*m_d)-m_d<<"\n";

   ROOT::Math::XYZVector momRec(-0.021864*1000.0,0.136026*1000.0,1.214899*1000.0);
   Double_t ERecTot =  79.7955 + m_Be10;//Ekin + mass
