void run_reco_proto(TString dataFile = "output_proto_10Be.root",TString parameterFile = "pATTPC.Feb2013.par"){
  ...
  // ------------------------------------------------------------------------
   ...
   run -> SetOutputFile("output_proto_reco_10Be.root");
  ...
  // rtdb -> setFirstInput(parIo2);
   ...
   HoughTask->SetLinearHough();
	 //HoughTask->SetRadiusThreshold(); // Truncate Hough Space Calculation
