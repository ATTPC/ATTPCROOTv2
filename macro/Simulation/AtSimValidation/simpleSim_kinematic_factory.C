...
void simpleSim_kinematic_factory(Int_t nEvents = 1000, UInt_t seed = 42)
{
   ...
   TString outFile = "./data/simpleSim_kinematic_factory.root";
   TString parFile = "./data/simpleSim_kinematic_factory_params.root";
   gSystem->Unlink(outFile);
   gSystem->Unlink(parFile);
