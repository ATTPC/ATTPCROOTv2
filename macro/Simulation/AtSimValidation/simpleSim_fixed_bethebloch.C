...
void simpleSim_fixed_bethebloch(Double_t thetaCms = 45.0, Int_t nEvents = 100, UInt_t seed = 42)
{
   ...
   TString outFile = "./data/simpleSim_fixed_bethebloch.root";
   TString parFile = "./data/simpleSim_fixed_bethebloch_params.root";
