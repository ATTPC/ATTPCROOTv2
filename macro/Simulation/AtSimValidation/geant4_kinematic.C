...
void geant4_kinematic(Int_t nEvents = 1000, UInt_t seed = 42, TString mcEngine = "TGeant4")
{
   ...
   TString outFile = "./data/geant4_kinematic.root";
   TString parFile = "./data/geant4_kinematic_params.root";
