void d_2He_sim_56Ni(Int_t nEvents = 100000, TString mcEngine = "TGeant4", TString geovar = "_1atm" )
{
 ...
 const TString pathtodata = "/mnt/simulations/attpcroot/data/";
  // Output file name
  TString outFile = pathtodata + "attpcsim_d2He_56Ni" + geovar + ".root";

  // Parameter file name
  TString parFile= pathtodata + "attpcpar_d2He_56Ni" + geovar + ".root";
