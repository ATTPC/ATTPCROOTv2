void O16He4_sim(Int_t nEvents = 100000, TString mcEngine = "TGeant4")
{

  TString dir = getenv("VMCWORKDIR");

  // Output file name
  TString outFile ="/home/david/PhD/PhD-14-02/attpcroot/ATTPCROOTv2/macro/Simulation/ATTPC/16O_aa/data/attpcsim.root";

  // Parameter file name
  TString parFile="/home/david/PhD/PhD-14-02/attpcroot/ATTPCROOTv2/macro/Simulation/ATTPC/16O_aa/data/attpcpar.root";
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	          ...
	          Double_t pz = 0.442/a;  // Z-Momentum / per nucleon!!!!!!
