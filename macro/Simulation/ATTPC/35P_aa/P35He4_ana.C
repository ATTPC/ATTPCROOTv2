...
void P35He4_ana(Int_t num_ev=20000)
{
	  ...
	  /*  TCanvas *c3 = new TCanvas();
	    ...
	    //std::vector<TString> files = {"data/attpcsim_35P_aa_gs","data/attpcsim_35P_aa_3_2+","data/attpcsim_35P_aa_1_2+2","data/attpcsim_35P_aa_5_2+"};
            std::vector<TString> files = {"data/attpcsim_35P_aa_gs_380torr","data/attpcsim_35P_aa_3_2+_380torr","data/attpcsim_35P_aa_1_2+2_380torr"};
            //std::vector<double> ex_energy = {0.0,2.386,3.0,3.859};
            std::vector<double> ex_energy = {0.0,2.386,3.0};
            //std::vector<int> xs_events = {20000,20000,2000,20000};
            std::vector<int> xs_events = {20000,20000,2000};
          ...
          for(auto iFile=0;iFile<files.size();++iFile)
	  {
				...
				if(iEvent%2!=0){
				   ...
				   // std::cout<<" energyLoss_sca : "<<energyLoss_sca<<std::endl;
				    ...
				    Double_t m_P35 = 34.973314117*931.49401;//35P
				    Double_t m_beam = 34.973314117*931.49401;
