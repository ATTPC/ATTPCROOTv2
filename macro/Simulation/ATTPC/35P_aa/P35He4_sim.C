void P35He4_sim(Int_t nEvents = 20000, TString mcEngine = "TGeant4")
{
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
                  ...
                  // Beam Information
                  Int_t z = 15;  // Atomic number
	          Int_t a = 35; // Mass number
		 ...
		 // Variables for 2-Body kinematics reaction
		  ...
		  std::vector<Double_t> ExE; // Excitation energy
                  double ResEner = 40.0;// MeV (energy of the beam in fixed target mode, no beam events)
		  ...
		  Pyp.push_back(py);
		  Pzp.push_back(pz);
		  Mass.push_back(34.973314117);//uma
