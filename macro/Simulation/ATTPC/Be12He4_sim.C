void Be12He4_sim(Int_t nEvents = 10, TString mcEngine = "TGeant4")
{
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	              ...
	              Double_t pz = 1.162/a;  // Z-Momentum / per nucleon!!!!!!
  	              Double_t BExcEner = 0.0;
                  Double_t Bmass = 11.20301; //Mass in GeV
                  Double_t NomEnergy = 60.0; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
