...
{
  TString mcFile = Form("/mnt/analysis/e18008/rootAna/giraud/simulation/g4/attpcsim_d2He_run%d_Ex%d_testUpdates.root",runNumber,(Int_t)ExEje);//attpcsim_d2He_14O_07atm_100000.root
  ...
  TString outputFile = Form("/mnt/analysis/e18008/rootAna/giraud/simulation/digi/attpcdigi_d2He_"+str_nEvents+"_run%d_Ex%d_testUpdates.root",runNumber,(Int_t)ExEje);
  ...
  ransacTask->SetRanSamMode(0);// SampleMethod { kUniform = 0, kChargeWeighted = 1, kGaussian = 2, kWeightedGaussian = 3, kWeightedY = 4 };
