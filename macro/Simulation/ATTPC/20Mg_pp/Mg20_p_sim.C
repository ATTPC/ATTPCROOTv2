void Mg20_p_sim(Int_t nEvents = 10, TString mcEngine = "TGeant4")
{
   ...
   Double_t NomEnergy = 110.0; // Nominal Energy of the beam: Only used for cross section calculation (Tracking energy
                               // is determined with momentum). TODO: Change this to the energy after the IC
