void Be10_He6aa_sim(Int_t nEvents = 10000, TString mcEngine = "TGeant4")
{
  ...
  Double_t NomEnergy = 38; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC 
