...
void run_digi_10Be()
{
   ...
   TString outputFile = "/home/david/PhD/PhD-14-02/attpcroot/ATTPCROOTv2/macro/Simulation/ATTPC/10Be_aa/data/output_H_digi.root";
   ...
   //   TString mcFile = inOutDir + "attpcsim.root";
      TString mcFile = inOutDir + "attpcsim_H.root";
