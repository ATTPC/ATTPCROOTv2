void C12_12C12C_sim(Int_t nEvents = 1000000, Int_t subnum = 0)
{
   ...
   //   TString outFile = "./data/attpcsim_12c12c.root";
   TString outFile = "./data1/attpcsim_12c12c_" + to_string(subnum) + ".root";

   // Parameter file name
   //   TString parFile = "./data/attpcpar.root";
   //   TString parFile = "./data/attpcpar_12c12c.root";
   ...
   ATTPC->SetGeometryFileName("rcnp_130matm.root");
   ...
   Double_t pz = 1.058294 / a; // Z-Momentum GeV/ per nucleon!!!!!!
   Double_t BExcEner = 0.0;
   Double_t Bmass = 12;
   //   Double_t Bmass = 11.99671;

   //   Double_t NomEnergy = 6.0;
   Double_t NomEnergy = 50.0;
   //   Double_t NomEnergy = 0.0;
   ...
   TString outgeoFile = "./data1/geofile_full_12c12c_" + to_string(subnum) + ".root";
