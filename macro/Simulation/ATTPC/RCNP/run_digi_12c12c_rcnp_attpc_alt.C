...
void run_digi_12c12c_rcnp_attpc_alt(int subnum = 0)
{
   TString inOutDir = "./data1/";
   //   TString outputFile = inOutDir + "output_digi.root";
   //   TString outputFile = inOutDir + "output_digi_rcnp_12c.root";
   TString outputFile = "./data1/output_digi_rcnp_12c_" + std::to_string(subnum) + ".root";
   ...
   //   TString mcFile = inOutDir + "attpcsim_12c12c.root";
