void run_Ar46_sim(Int_t nEvents = 2, TString mcEngine = "TGeant4")
{
 ...
 // ------------------------------------------------------------------------
    ...
    fMagField->SetField(0., 0. ,18. ); // values are in kG
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	...
	Double_t pz = 3.25974/a;  // Z-Momentum / per nucleon!!!!!!
	Double_t BExcEner = 0.0;
	Double_t Bmass = 42.844; //Mass in GeV
	Double_t NomEnergy = 42.844; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
	Double_t TargetMass = 0.9314;//Mass in GeV
