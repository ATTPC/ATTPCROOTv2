...
void digi_Be13_p(int nEvent = 10000)
{
   ...
   TString mcFile = TString::Format("/data/ATTPCROOTv2_results/E565/Simulation/simFiles/attpcsim_13Be_p_%.1f_%.1f_600Torr_2_53MeV.root", ThetaMinCMS, ThetaMaxCMS);
   ...
   TString outputFile = TString::Format("/data/ATTPCROOTv2_results/E565/Simulation/digiFiles/output_digi_rcnp_13Be_p_%.1f_%.1f_600Torr_9mmBinning_2_53MeV.root", ThetaMinCMS, ThetaMaxCMS);
