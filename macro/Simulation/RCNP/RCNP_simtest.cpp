void RCNP_simtest(Int_t nEvents = 5000, TString mcEngine = "TGeant4")
{
  ...
  ATTPC->SetGeometryFileName("RCNP_ATTPC.root");
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	        ...
	        Double_t pz = 0.733/a;  // Z-Momentum / per nucleon!!!!!!
  	        Double_t BExcEner = 0.0;
                Double_t Bmass = 12.02473; //
                Double_t NomEnergy = 120.0; //Used to force the beam to stop within a certain energy range.
