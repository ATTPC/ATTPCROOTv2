// 17N (d,3He) 16C
// Beam energy 45 MeV/u
// Neutron separation energy 4.25 MeV
// 

void RCNP_e534(Int_t nEvents = 500, TString mcEngine = "TGeant4")
{

  TString dir = getenv("VMCWORKDIR");

  // Output file name
  TString outFile ="rcnp_e534.root";

  // Parameter file name
  TString parFile="./data/attpcpar_e534.root";
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	        ...
	        Double_t pz = 4.983/a;  // Z-Momentum / per nucleon!!!!!!
  	        Double_t BExcEner = 0.0;
                Double_t Bmass = 17.00461; //
