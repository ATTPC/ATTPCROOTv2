void DeGAi_137Cs(Int_t nEvents = 50000, TString mcEngine = "TGeant4")
{

   TString dir = getenv("VMCWORKDIR");

   // Output file name
   TString outFile = "./DeGAi_137Cs.root";
   ...
   Double_t pdgId = 22;       // 22 for gamma emission, 2212 for proton emission
	...
	gammasGen->SetNuclearDecayChain();
     gammasGen->SetDecayChainPoint(0.0002835,5.8e-6);
     gammasGen->SetDecayChainPoint(0.000661657,0.851);
