void np_sim(Int_t nEvents = 1000, TString mcEngine = "TGeant4")
{
   ...
   ATTPC->SetGeometryFileName("FRIB_TPC_v2.root");
   ...
   // Beam Information
   Int_t z = 1; // Atomic number
   Int_t a = 2; // Mass number
   ...
   Double_t pz = 0.045 / a; // Z-Momentum / per nucleon!!!!!!
   Double_t BExcEner = 0.0;
   Double_t Bmass = 1.007276466879;
   Double_t NomEnergy = 1;

   AtTPCIonGenerator *ionGen = new AtTPCIonGenerator("Ion", z, a, q, m, px, py, pz, BExcEner, Bmass, NomEnergy);
   ionGen->SetSpotRadius(0, -100, 2.3, 0.5);
   ...
   Pyp.push_back(py);
   Pzp.push_back(pz);
   Mass.push_back(1.007276466879); // uma
   ...
   Pyp.push_back(0.0);
   Pzp.push_back(0.0);
   Mass.push_back(24.990428095); // uma
   ExE.push_back(0.0);
