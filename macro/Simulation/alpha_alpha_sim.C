void alpha_alpha_sim(Int_t nEvents = 1000, TString mcEngine = "TGeant4")
{
 ...
 // ------------------------------------------------------------------------
    ...
    fMagField->SetField(0., 0. ,5.691 ); // values are in kG
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
                ...
                Int_t z = 2;  // Atomic number
	              ...
	              Double_t pz = 0.24131/a;  // Z-Momentum / per nucleon!!!!!!
  	            Double_t BExcEner = 0.0;
                Double_t Bmass = 3.728401; //Mass in GeV
                Double_t NomEnergy = 7.8029; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
