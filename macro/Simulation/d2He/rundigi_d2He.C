...
{
  TString mcFile = Form("/mnt/analysis/e18008/rootAna/giraud/simulation/g4/attpcsim_d2He_run%d_Ex%d.root",runNumber,(Int_t)ExEje);//attpcsim_d2He_14O_07atm_100000.root
  ...
  TString parFile = Form("/mnt/analysis/e18008/rootAna/giraud/simulation/g4/attpcpar_d2He_run%d_Ex%d.root",runNumber,(Int_t)ExEje);    //"attpcpar_d2He_test_10k.root")//attpcpar_d2He_14O_07atm_100000.root
  ...
  fRun -> SetOutputFile(Form("/mnt/analysis/e18008/rootAna/giraud/simulation/digi/attpcdigi_d2He_"+str_nEvents+"_run%d_Ex%d.root",runNumber,(Int_t)ExEje));
