...
static double coeff_hodo[32] = {100000000, 1164, 887, 100000000, 824, 1728, 826,
	...
	void runana_merg_cal_d2He()
	{
		...
		TTreeReaderValue<std::vector<ATRANSACN::ATRansac::PairedLines>> ransacArray(reader, "PLines");
		...
		for(Int_t i=0;i<nEvents;i++){
			...
			S800_x0 = s800cal.GetCRDC(0)->GetY();
			S800_x1 = s800cal.GetCRDC(1)->GetY();
			...
			*/
			//	std::cout<<i<<" "<<lines.size()<<" "<<s800cal.GetTS()<<" "<<s800cal.GetMultiHitTOF()->GetFirstRfHit()<<" "<<s800cal.GetCRDC(0)->GetY()<<std::endl;
