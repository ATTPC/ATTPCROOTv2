...
void d2He_ana_14Onew(TString geofile = "_07atm", Double_t elhueco=5)
{
	...
	//TString mcFileNameHead = "attpcsim_d2He_56Nigsattpcsim_d2He_test.root" + geofile;
	//TString mcFileNameTail = ".root";
	//TString mcFileName     = pathtodata + mcFileNameHead + mcFileNameTail;
	TString mcFileName     = pathtodata + "attpcsim_d2He_test_nodecay.root";
	...
	TString  outFileNameHead = "hist_d2He_14O_nodecay" + geofile + ".root";
	...
	TH2D *eloss_range_p1 = new TH2D("Eloss_vs_range_p1","Eloss_vs_Range_p1",100,0,5,100,0,500);
	TH2D *eloss_range_p2 = new TH2D("Eloss_vs_range_p2","Eloss_vs_Range_p2",100,0,5,100,0,500);
	...
	Int_t t_iEvt = 0;
	Double_t t_av_dE_p1 = 0;
	Double_t t_av_dE_p2 = 0;
	Double_t t_energyLoss_p1 = 0;
	Double_t t_energyLoss_p2 = 0;
	Double_t t_avetheta_p1 = 0;
	Double_t t_avetheta_p2 = 0;
	Double_t t_theta_p1_fit = 0;
	Double_t t_theta_p2_fit = 0;
	Int_t t_goodfit = 0;
	Double_t t_dist_vertex = 0;
	Int_t t_goodvertex = 0;
	Double_t t_eLoss_p1_reco = 0;
	Double_t t_eLoss_p2_reco = 0;
	Double_t t_eLoss_p1_hi = 0;
	Double_t t_range1_hi = 0;
	Double_t t_range1_low = 0;
	Double_t t_mom_proton1_res = 0;
	Double_t t_mom_proton2_res = 0;
	Double_t t_mom_He2_res = 0;
	Double_t t_ex_he2_res = 0;
	Double_t t_kin_He2 = 0;
	Double_t t_theta_He2 = 0;
	Double_t t_phi_He2 = 0;
	Double_t t_Ex4 = 0;
	Double_t t_theta_cm = 0;
	Double_t t_mom_He2 = 0;
	Double_t t_mom_proton1 = 0;
	Double_t t_mom_proton2 = 0;
	Double_t t_ex_he2 = 0;
	Double_t t_theta_He2_pur = 0;
	Double_t t_phi_He2_pur = 0;
	Double_t t_kin_He2_pur = 0;
	Double_t t_theta_cm_pur = 0;
	Double_t t_Ex4_pur = 0;
	Double_t t_range_p1 = 0;
	Double_t t_range_p2 = 0;
	...
	t1->Branch(" t_iEvt" ,&t_iEvt,"t_iEvt/I");
	t1->Branch(" t_av_dE_p1",&t_av_dE_p1,"t_av_dE_p1/D");
	t1->Branch(" t_av_dE_p2",&t_av_dE_p2,"t_av_dE_p2/D");
	t1->Branch(" t_energyLoss_p1",&t_energyLoss_p1,"t_energyLoss_p1/D");
	t1->Branch(" t_energyLoss_p2",&t_energyLoss_p2,"t_energyLoss_p2/D");
	t1->Branch(" t_avetheta_p1",&t_avetheta_p1,"t_avetheta_p1/D");
	t1->Branch(" t_avetheta_p2",&t_avetheta_p2,"t_avetheta_p2/D");
	t1->Branch(" t_theta_p1_fit",&t_theta_p1_fit,"t_theta_p1_fit/D");
	t1->Branch(" t_theta_p2_fit",&t_theta_p2_fit,"t_theta_p2_fit/D");
	t1->Branch(" t_goodfit",&t_goodfit,"t_goodfit/I");
	t1->Branch(" t_dist_vertex",&t_dist_vertex,"t_dist_vertex/D");
	t1->Branch(" t_goodvertex",&t_goodvertex,"t_goodvertex/I");
	t1->Branch(" t_eLoss_p1_reco",&t_eLoss_p1_reco,"t_eLoss_p1_reco/D");
	t1->Branch(" t_eLoss_p2_reco",&t_eLoss_p2_reco,"t_eLoss_p2_reco/D");

	t1->Branch(" t_eLoss_p1_hi",&t_eLoss_p1_hi,"t_eLoss_p1_hi/D");
	t1->Branch(" t_range1_hi",&t_range1_hi,"t_range1_hi/D");
	t1->Branch(" t_range1_low",&t_range1_low,"t_range1_low/D");

	t1->Branch(" t_mom_proton1_res",&t_mom_proton1_res,"t_mom_proton1_res/D");
	t1->Branch(" t_mom_proton2_res",&t_mom_proton2_res,"t_mom_proton2_res/D");
	t1->Branch(" t_mom_He2_res",&t_mom_He2_res,"t_mom_He2_res/D");
	t1->Branch(" t_ex_he2_res",&t_ex_he2_res,"t_ex_he2_res/D");
	t1->Branch(" t_kin_He2",&t_kin_He2,"t_kin_He2/D");
	t1->Branch(" t_theta_He2",&t_theta_He2,"t_theta_He2/D");
	t1->Branch(" t_phi_He2",&t_phi_He2,"t_phi_He2/D");
	t1->Branch(" t_Ex4",&t_Ex4,"t_Ex4/D");
	t1->Branch(" t_theta_cm",&t_theta_cm,"t_theta_cm/D");
	t1->Branch(" t_mom_He2",&t_mom_He2,"t_mom_He2/D");
	t1->Branch(" t_mom_proton1",&t_mom_proton1,"t_mom_proton1/D");
	t1->Branch(" t_mom_proton2",&t_mom_proton2,"t_mom_proton2/D");
	t1->Branch(" t_ex_he2",&t_ex_he2,"t_ex_he2/D");
	t1->Branch(" t_theta_He2_pur",&t_theta_He2_pur,"t_theta_He2_pur/D");
	t1->Branch(" t_phi_He2_pur",&t_phi_He2_pur,"t_phi_He2_pur/D");
	t1->Branch(" t_kin_He2_pur",&t_kin_He2_pur,"t_kin_He2_pur/D");
	t1->Branch(" t_theta_cm_pur",&t_theta_cm_pur,"t_theta_cm_pur/D");
	t1->Branch(" t_Ex4_pur",&t_Ex4_pur,"t_Ex4_pur/D");
	t1->Branch(" t_range_p1",&t_range_p1,"t_range_p1/D");
	t1->Branch(" t_range_p2",&t_range_p2,"t_range_p2/D");

	//--------------------------------------------------------


	for(Int_t iEvent=0; iEvent<200; iEvent++)
	//for(Int_t iEvent=0; iEvent<nEvents; iEvent++)
	{

////check results of digi
Double_t zpos_p1_f = 0.0;
Double_t xpos_p1_f = 0.0;
Double_t ypos_p1_f = 0.0;

Double_t zpos_p2_f = 0.0;
Double_t xpos_p2_f = 0.0;
Double_t ypos_p2_f = 0.0;
...
//
		...
		Double_t Ekin_proj = 115.0 * mass_proj_uma;//100.
		...
		Double_t real_vertex_x = 0;
		Double_t real_vertex_y = 0;
		//
		...
		std::cout<<iEvent<<" Npoints "<<Npoints<<std::endl;
		for(Int_t i=0; i<Npoints; i++) {
			...
			if(iEvent%2!=0 && trackID!=1 && VolName=="drift_volume"){  //solo los protones
				...
				if(i==0) {real_vertex = zpos;real_vertex_x = xpos;real_vertex_y = ypos; t_x_v = xpos; t_y_v = ypos;}
				...
				if(trackID==2){
					...
					if(rpos>holeradius){
						...
						//cout <<range1_hi<<"  "<<range_p1<<"  "<<sqrt( sq(xpos1_hi) + sq(ypos1_hi) + sq(zpos1_hi - real_vertex))<<"  "<<xpos1_hi<<" "<<ypos1_hi<<" "<<zpos1_hi<<" "<<xpos<<" "<<ypos<<" "<<zpos<<endl;
						// cout<<" "<<endl;
					}
		...
		if(iEvent%2!=0 && points1>0 && points2>0){
			...
			t_av_dE_p1 = av_dE_p1;
			t_av_dE_p2 = av_dE_p2;
			t_energyLoss_p1 = energyLoss_p1;
			t_energyLoss_p2 = energyLoss_p2;
			...
			//Double_t vertex_p1_fit_other0 = d2heana->GetVertexFit_other0();
			//Double_t vertex_p1_fit_other1 = d2heana->GetVertexFit_other1();
			//Double_t vertex_p1_fit_other3 = d2heana->GetVertexFit_other3();
			...
			//Double_t vertex_p2_fit_other0 = d2heana->GetVertexFit_other0();
			//Double_t vertex_p2_fit_other1 = d2heana->GetVertexFit_other1();
			//Double_t vertex_p2_fit_other3 = d2heana->GetVertexFit_other3();
			bool goodfit_p2 = d2heana->GetFitStatus();

			theta_res->Fill(avetheta_p1,theta_p1_fit);
			theta_res->Fill(avetheta_p2,theta_p2_fit);

			t_avetheta_p1 = avetheta_p1;
			t_avetheta_p2 = avetheta_p2;
			t_theta_p1_fit = theta_p1_fit;
			t_theta_p2_fit = theta_p2_fit;


			//cout<<iEvent<<" "<<real_vertex_x<<" "<<real_vertex_y<<" "<<real_vertex<<" // "<< vertex_p1_fit <<" // "<<vertex_p2_fit<<" "<<endl;
			...
			t_goodfit = 0;
			t_dist_vertex = 0;
			if(goodfit) t_goodfit = 1;
			t_dist_vertex = fabs(vertex_p2_fit - vertex_p1_fit);
			...
			if(goodfit==true && (av_dE_p1 >threseloss && av_dE_p2 > threseloss) ){
				...
				// range1_low = sqrt( sq(xpos1_hi) + sq(ypos1_hi) + sq(zpos1_hi - real_vertex));
				// range2_low = sqrt( sq(xpos2_hi) + sq(ypos2_hi) + sq(zpos2_hi - real_vertex));
				range1_low = sqrt( sq(xpos1_hi - real_vertex_x) + sq(ypos1_hi - real_vertex_y) + sq(zpos1_hi - real_vertex));
				range2_low = sqrt( sq(xpos2_hi - real_vertex_x) + sq(ypos2_hi - real_vertex_y) + sq(zpos2_hi - real_vertex));
				if(geofile == "_07atm"){
				...
				t_eLoss_p1_hi = eLoss_p1_hi;
				t_range1_hi = range1_hi;
				t_range1_low = range1_low;
				...
				t_eLoss_p1_reco = eLoss_p1_reco;
				t_eLoss_p2_reco = eLoss_p2_reco;
				t_mom_proton1_res = mom_proton1_res.Mag2();
				t_mom_proton2_res = mom_proton2_res.Mag2();
				...
				t_mom_He2_res = mom_He2_res.Mag2();
				...
				t_ex_he2_res = he2_mass_ex - he2_mass;
		...
		if(av_dE_p1 >threseloss && av_dE_p2 > threseloss && iEvent%2!=0){
			...
			eloss_range_p1->Fill(energyLoss_p1,range_p1);
			eloss_range_p2->Fill(energyLoss_p2,range_p2);
			...
			t_mom_proton1 = mom_proton1.Mag2();
			t_mom_proton2 = mom_proton2.Mag2();
			t_mom_He2 = mom_He2.Mag2();
			t_ex_he2 = he2_mass_ex - he2_mass;
			t_theta_He2_pur = theta_He2;
			t_phi_He2_pur = phi_He2;
			t_kin_He2_pur = kin_He2;
			...
			t_theta_cm_pur = theta_cm;
			t_Ex4_pur = Ex4;

//to compare with digi
/*			cout<<"  "<<endl;
			cout<<"Event "<<iEvent<<endl;
			cout<<"Vertex "<<real_vertex<<" "<<real_vertex_x<<" "<<real_vertex_y<<endl;
			cout<<"1 pos // range "<<zpos_p1_f<<" "<<xpos_p1_f<<" "<<ypos_p1_f<<" // "<<sqrt(pow(real_vertex-zpos_p1_f,2) + pow(real_vertex_x-xpos_p1_f,2) +pow(real_vertex_y-ypos_p1_f,2))<<endl;
			cout<<"2 pos // range "<<zpos_p2_f<<" "<<xpos_p2_f<<" "<<ypos_p2_f<<" // "<<sqrt(pow(real_vertex-zpos_p2_f,2) + pow(real_vertex_x-xpos_p2_f,2) +pow(real_vertex_y-ypos_p2_f,2))<<endl;
			cout<<"Eloss "<<energyLoss_p1<<" "<<energyLoss_p2<<" "<<endl;
			cout<<"Angles theta // phi "<<avetheta_p1<<" "<<avetheta_p2<<" // "<<avephi_p1<<" "<<avephi_p2<<endl;
			cout<<"Ex // theta CM "<<Ex4<<" // "<<theta_cm<<endl;
*/
//
...
t1->Write();
	...
	eloss_range_p1->Write();
	eloss_range_p2->Write();
	avth_eloss_p1->Write();
	avth_eloss_p2->Write();
	avth1_avth2->Write();
	Eloss1_Eloss2->Write();
