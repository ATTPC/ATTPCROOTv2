...
vector <int> EvtMatch(const vector<Long64_t> &TsEvtS800, const vector<Long64_t> &TsEvtATTPC, TF1 *fit)
{
  ...
  int S800_ATTPC_merger() {
    ...
    TString fileATTPC="/projects/ceclub/giraud/ATTPCROOTv2/macro/Simulation/d2He/outputFiles/attpcdigi_d2He_1000.root";//projects/ceclub/giraud/ATTPCROOTv2/macro/Unpack_HDF5/
