...
void d2He_ana_12N_1atm(TString geofile = "_1atm", Double_t elhueco=40)
{
    ...
    TString mcFileNameHead = "attpcsim_d2He_12N" + geofile;
	...
	TFile* outfile;
        ...
        TString  outFileNameHead = "hist_d2He_12N" + geofile + string_hole.str() + ".root";
	...
	Double_t mass_proj_uma = 12.018613196;
	Double_t mass_reco_uma =12.000000000;
