...
void ana_digi_d2He()
{
    ...
    for(Int_t i=0;i<nEvents;i++){
              ...
              Reader1.Next();
              ATHoughSpaceLine* fHoughSpaceLine  = dynamic_cast<ATHoughSpaceLine*> (houghArray->At(0));


              if(fHoughSpaceLine==NULL) std::cout<<" Null pointer "<<"\n";
              	...
              	if(i%2!=0){
              	  ...
              	  //const std::vector<double> parameter = fHoughSpaceLine->GetInitialParametersVector();	              
