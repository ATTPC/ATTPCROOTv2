void d_2He_14ONew(Int_t nEvents = 50, TString mcEngine = "TGeant4", TString geovar = "_07atm")
{
  ...
  TString geoname = "ATTPC_d2He" + geovar + "_test.root";
...
//  ATTPCIonGenerator* ionGen = new ATTPCIonGenerator("Ion",z,a,q,m,px,py,pz,BExcEner,Bmass,NomEnergy);
  // ionGen->SetSpotRadius(1.,30.,0.05,0.,0.); // incoming beam Spot radius (standard dev) [cm], z [cm] beam focus in the tpc, beam convergance angle [rad], offset position [cm], offset angle [rad] (beam axis relatively to symmetry axis of the detector)
