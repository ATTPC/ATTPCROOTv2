void findEvents(int tpc_run_num=118)
{
  ...
  for(int i = 0; i < tpc_nevents; ++i)
  {
	...
	TVector3 p1(ransac_ary[validTrackIndex[0]].GetFitPar()[0],
		    ransac_ary[validTrackIndex[0]].GetFitPar()[2],
		    0);
	TVector3 d1(ransac_ary[validTrackIndex[0]].GetFitPar()[1],
		    ransac_ary[validTrackIndex[0]].GetFitPar()[3],
		    1);	
	TVector3 p2(ransac_ary[validTrackIndex[1]].GetFitPar()[0],
		    ransac_ary[validTrackIndex[1]].GetFitPar()[2],
		    0);
	TVector3 d2(ransac_ary[validTrackIndex[1]].GetFitPar()[1],
		    ransac_ary[validTrackIndex[1]].GetFitPar()[3],
		    1);
