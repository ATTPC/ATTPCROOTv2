...
void run_digi_response()
{
   TString inOutDir = "~/attpcroot/macro/tests/AT-TPC/data/";
   ...
   mapping->ParseInhibitMap("~/attpcroot/macro/tests/AT-TPC/data/inhibit.txt", AtMap::InhibitType::kTotal);
   ...
   pulse->SetResponseFunction(&AtVectorResponse::ResponseFunction);
   AtVectorResponse::SetFile("/mnt/analysis/e12014/huntc/newFork/ATTPCROOTv2/code/macros/waveSample.txt");
   //  return;
