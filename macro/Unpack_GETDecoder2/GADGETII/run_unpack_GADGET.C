void run_unpack_GADGET(TString dataFile = "GADGET-alpha-source-data2.txt", TString parameterFile = "GADGET.sim.par",
                       TString mappath = "")
...

{
   ...
   /*
    *     Unpacking options:
    *         - SetUseSeparatedData:      To be used with 10 CoBo files without merging. Mainly for the ATTPC. Enabled
    * if the input file is a txt.
    ...
    *         - SetMapOpt                 Chose the pad plane geometry. In addition forces the unpacker to use Basic
    * Frames for 1 single file (p-ATTPC case) of Layered Frames for Merged Data (10 Cobos merged data).
    */
