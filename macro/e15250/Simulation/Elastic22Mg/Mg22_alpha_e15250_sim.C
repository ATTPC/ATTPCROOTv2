void Mg22_alpha_e15250_sim(Int_t nEvents = 1000, TString mcEngine = "TGeant4")
{

  TString dir = getenv("VMCWORKDIR");

  // Output file name
  TString outFile ="./data/attpcsim_e15250.root";

  // Parameter file name
  TString parFile="./data/attpcpar_e15250.root";
  ...
  Int_t z = 12;  // Atomic number
	...
	Double_t pz = 2.0498/a;  // Z-Momentum / per nucleon!!!!!!
  Double_t BExcEner = 0.0; 
  //Double_t Bmass = 20.49247; //Mass in GeV
  Double_t Bmass = 21.999570654; //Mass in u.m.a.
  Double_t NomEnergy = 102.3; //Nominal Energy of the beam: Only used for cross section calculation (Tracking energy is determined with momentum). TODO: Change this to the energy after the IC
  Double_t TargetMass = 4.002603235413;//Mass in GeV
...
// Cambiamos la cinemática --> loq queremos detectar a la salida
  //--- Scattered -----alpha 
  ...
  Pyp.push_back(0.0);
  Pzp.push_back(0.0);
  Mass.push_back(4.002603235413);
	ExE.push_back(0.0);//In MeV

 // ---- Recoil ----- 
  
  Zp.push_back(10); // 22Mg TRACKID=1
  	Ap.push_back(22); //
  	Qp.push_back(0);
  Pxp.push_back(0.0);
  Pyp.push_back(0.0);
  Pzp.push_back(0.0);
  Mass.push_back(21.999570654);
  ExE.push_back(0.0);
