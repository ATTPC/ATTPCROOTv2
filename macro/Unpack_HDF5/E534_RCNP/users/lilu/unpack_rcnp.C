...
void unpack_rcnp(int run_start = 2011,int run_end = 2014){
  for(int run_num=run_start;run_num<= run_end;run_num++){
  ...
  TString parameterFile = "RCNP/ATTPC.E534.par";
  TString mappath = "";
  TString filepath = "/data/tempMergedData/E534/";
  TString fileExt = ".h5";
  TString outputpath = "/data/ATTPCROOTv2_results/E534/UnpackerOutput/";
