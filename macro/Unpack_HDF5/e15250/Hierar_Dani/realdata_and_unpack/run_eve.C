void run_eve(TString  InputDataFile = "run_0290.root",TString  OutputDataFile = "output.reco_display.root", TString unpackDir="./")
{
  FairLogger *fLogger = FairLogger::GetLogger();
  fLogger -> SetLogToScreen(kTRUE);
  fLogger->SetLogVerbosityLevel("MEDIUM");
  TString dir = getenv("VMCWORKDIR");
  TString geoFile = "ATTPC_Mg22elastic_geomanager.root";
