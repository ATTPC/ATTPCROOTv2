...
void unpack_new(int runNumberS800=2272, int runNumberATTPC=272)
{
  ...
  TString outputFile = TString::Format("/mnt/analysis/e18008/rootMerg/giraud/run_%04d_%04d_test15.root", runNumberS800, runNumberATTPC);
...
/* merge task */
 ...
 // HDFParserTask->SetAuxChannel(hash, "IonCb_34");
  ...
  MergeEvt->SetPID1cut("/projects/ceclub/giraud/git/ATTPCROOTv2/macro/Unpack_HDF5/e18008_S800/rootPID/XfObjObj_run60to70.root");//can have multiple gates for PID1
  MergeEvt->SetPID3cut("/projects/ceclub/giraud/git/ATTPCROOTv2/macro/Unpack_HDF5/e18008_S800/rootPID/ICSumObj_run60to70.root");//can have multiple gates for PID2
