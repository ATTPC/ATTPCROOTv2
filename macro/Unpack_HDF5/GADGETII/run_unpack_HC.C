...
void run_unpack_HC(std::string dataFile = "/mnt/analysis/attpc/run_0002.h5", TString parameterFile = "GADGET.sim.par",
                   TString mappath = "")
{
   ...
   TString geoManFile = dir + "/geometry/GADGET_II_lp.root";
   ...
   AtHDFParserTask *HDFParserTask = new AtHDFParserTask(2); // Select 2 for GADGETII
