...
//  TString inputFile = TString::Format("hdf5Files/run_%04d.h5", runNumber);
  ...
  TString inputFile = TString::Format("/mnt/daqtesting/e18027_attpc_transfer/h5/run_%04d.h5", runNumber);

  //Set the output file
  TString outputFile = TString::Format("/mnt/analysis/e18027/rootATTPC/run_unpacked_%04d.root", runNumber);
