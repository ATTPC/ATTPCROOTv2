...
void re_process(int runNumberS800, int runNumberATTPC)
{
  ...
  TString InputDataFile = TString::Format("/mnt/analysis/e18027/rootMerg/run_%04d_%04d.root", runNumberS800, runNumberATTPC);

  //Set the output file
  TString outputFile = TString::Format("/mnt/analysis/e18027/rootAna/reprocess/reprocess_%04d_%04d.root", runNumberS800, runNumberATTPC);
