//Unpacks tpc files from /mnt/daqtesting/e18027_attpc_transfer to /mnt/analysis/e18027/rootMerg/
...
void unpack_new(int runNumberS800, int runNumberATTPC)
{
  ...
  TString inputFile = TString::Format("/mnt/daqtesting/e18027_attpc_transfer/h5/run_%04d.h5", runNumberATTPC);
  ...
  //Set the output file
  // TString outputFile = TString::Format("/mnt/analysis/e18027/rootMerg/run_2%03d_%04d.root", runNumberS800, runNumberATTPC);
  TString outputFile = TString::Format("/mnt/analysis/e18027/rootMerg/run_%04d_%04d.root", runNumberS800, runNumberATTPC);
 ...
 // TString scriptfile = "Lookup20150611.xml";//"Lookup20150611.xml";
  ...
  TString parameterFile = "ATTPC.e18027.par";
 ...
 // Double_t corrGainE1down = 1.;
  ...
  S800MTDCObjCorr.push_back(100.);
  S800MTDCObjCorr.push_back(0.009);
  std::vector<Double_t> S800MTDCObjRange;
  S800MTDCObjRange.push_back(-115);
  S800MTDCObjRange.push_back(-20);
  std::vector<Double_t> S800MTDCXfRange;
  S800MTDCXfRange.push_back(140);
  S800MTDCXfRange.push_back(230.);
  // TString S800File = "/projects/ceclub/giraud/s800root_jorge/s800root/files/rootFiles/cal/test-runs800-48Ca-CAL-0001-new.root";
  // TString S800File = TString::Format("/mnt/analysis/e18027/rootS800/cal/run-2%03d-00.root", runNumberS800);
  TString S800File = TString::Format("/mnt/analysis/e18027/rootS800/cal/run-%04d-00.root", runNumberS800);
  ...
  MergeEvt->SetTsDelta(1492);//was 1492 when tested with cosmics e18027
  ...
  //MergeEvt->SetPID1cut("cuts/beamPIDNi.root");
  //MergeEvt->SetPID2cut("cuts/Ni69_Ni68.root");
  //MergeEvt->SetPID1cut("cuts/tof.root");
  MergeEvt->SetPID1cut("cuts/XfObj_run101.root");
  //MergeEvt->SetPID1cut("cuts/XfObjNewSetting.root");
  //MergeEvt->SetPID2cut("cuts/afp.root");
  MergeEvt->SetPID2cut("cuts/afpx_run101.root");
  //MergeEvt->SetPID2cut("cuts/afpxNewSetting.root");
  //MergeEvt->SetPID3cut("cuts/cutNi.root");
  MergeEvt->SetPID3cut("cuts/Ni66-69_run101.root");
  //MergeEvt->SetPID3cut("cuts/NiNewSetting.root");
  ...
  psaTask -> SetThreshold(100);//50//100//200
...
*/
  ...
  RandTask->SetDistanceThreshold(10.0);//15.
  RandTask->SetMinHitsLine(22);//7
  ...
  RandTask->SetChargeThreshold(300);
  RandTask->SetVertexMode(0);
