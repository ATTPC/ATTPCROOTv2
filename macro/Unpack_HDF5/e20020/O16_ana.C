...
void O16_ana()
{
   ...
   TH2F *angle_vs_energy = new TH2F("angle_vs_energy", "angle_vs_energy", 720,0, 179, 1000, 0, 200.0);
   ...
   for (Int_t i = 0; i < nEvents; i++) {
     ...
     //eventArray->Clear();
      ...
      if (patternEvent) {
	   ...
	   if(track.GetHitArray()->size()>20) angle_vs_energy->Fill(theta*TMath::RadToDeg(),ener*Am);

	   std::cout<<" Brho : "<<bro<<" - Angle : "<<theta*TMath::RadToDeg()<<" - Radius : "<<rad<<" - Energy :"<<ener*Am<<"\n";
