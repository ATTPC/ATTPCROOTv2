...
void unpack_rcnp_BCFinder_test(int run_num = 3001){
  ...
  TString fileExt = ".h5";
  TString outputpath = "/data/ATTPCROOTv2_results/E535/UnpackerOutput/test/";
   ...
   */
   std::unique_ptr<AtTools::AtELossCATIMA> eLossModelC3D8_3He = std::make_unique<AtTools::AtELossCATIMA>(density, "CATima_C3D8_494_3Torr_3He");
   eLossModelC3D8_3He->SetMaterial(materialComponents);
   eLossModelC3D8_3He->SetProjectile(3, 2, 14.93121888);
   eLossModels.push_back(std::move(eLossModelC3D8_3He));
