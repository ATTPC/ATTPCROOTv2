...
void unpackRawEvents(int run_num = 2011){
  ...
  TString parameterFile = "RCNP/ATTPC.E581.par";
  TString mappath = "";
  TString filepath = "/data/tempMergedData/E581/";
  TString fileExt = ".h5";
  TString outputpath = "/data/ATTPCROOTv2_results/E581/UnpackerOutput/";
  ...
  TString outputFile = outputpath + fileName + "_RawEvents.root";
