void merge_data(){
    ...
    for (int irun = 4061; irun<= 4072; irun++)
    {
    if (irun == 6067) continue;
    ss.Form("/home/attpc/fair_install/ATTPCROOTv2-RCNPAnalysisBranch/macro/Unpack_HDF5/E581_RCNP/vertex_data/vertex_%d_test.root",irun);
...
//    if(!tree_get)continue;
  ...
  //  if(!opf1)continue;
    ...
    ss.Form("./merge_data/merge_%d.root", irun);
