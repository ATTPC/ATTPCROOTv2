void run_eve_BCF(int runNum = 3001, TString OutputDataFile = "./run_3001_display.root")
{
  //  TString InputDataFile = TString::Format("/data/ATTPCROOTv2_results/E535/UnpackerOutput/run_%04d.root", runNum);
  TString InputDataFile = TString::Format("/data/ATTPCROOTv2_results/E535/UnpackerOutput/test/run_%04d.root", runNum);
