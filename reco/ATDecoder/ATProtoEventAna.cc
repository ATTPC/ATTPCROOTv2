...
std::vector<std::vector<Double_t>>* ATProtoEventAna::GetELossHitPattern()                    {return &fELossHitPattern;}
...
void ATProtoEventAna::SetELHitPattern(std::vector<std::vector<Double_t>> ELHitPattern )      {fELossHitPattern = ELHitPattern; }
