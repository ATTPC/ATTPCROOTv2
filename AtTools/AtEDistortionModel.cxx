...
Bool_t AtEDistortionModel::SetCorrectionMaps(const std::string& zlut,const std::string& radlut,const std::string& tralut)
{
...
std::tuple<Double_t,Double_t,Double_t> AtEDistortionModel::GetCorrectionFactors(const Int_t& radius, const Int_t& zpos)
{
